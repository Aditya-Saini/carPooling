...
class User{
    ...
    // SING UP USER
    function singUpUser($username, $email, $password, $phone, $gender){
        try{
            ...
            if(!empty($this->user_name) && !empty($this->user_email) && !empty($this->user_pass) && !empty($this->user_phone) && !empty($this->user_gender)){
                ...
                if (filter_var($this->user_email, FILTER_VALIDATE_EMAIL)) { 
                    ...
                    if($check_email->rowCount() > 0){
                        ...
                        $sql = "INSERT INTO `users` (username, user_email, user_password, user_image, user_phone, user_gender) VALUES(:username, :user_email, :user_pass, :user_image, :user_phone, :user_gender)";
